...
```{r}
download.file("https://s3-us-west-2.amazonaws.com/10x.files/samples/cell/pbmc3k/pbmc3k_filtered_gene_bc_matrices.tar.gz", "pbmc3k.tar.gz")

untar("pbmc3k.tar.gz", compressed = T)
```
